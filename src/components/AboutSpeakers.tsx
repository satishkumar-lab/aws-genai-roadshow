...
export default function AboutSpeakers() {
  return (
    <section
      id="about"
      className="relative w-full scroll-mt-[66px] overflow-hidden bg-white pb-[72px] pt-12 md:pb-[100px] md:pt-20"
    >
      <img
      ...
      <div className="relative mx-auto grid w-full min-w-0 max-w-[1440px] gap-8 px-5 md:px-10 lg:grid-cols-[minmax(0,360px)_minmax(0,1fr)] lg:gap-20 xl:px-[100px]">
        <motion.h2
          className="text-[32px] font-bold leading-[44px] text-[#292929] md:text-[44px] md:leading-[50px]"
          variants={fadeUp}
          initial="hidden"
          whileInView="show"
        ...
        <motion.div
          className="flex min-w-0 flex-col gap-4 md:gap-0"
          variants={fadeUp}
          initial="hidden"
          whileInView="show"
          viewport={viewportOnce}
      ...
      <div className="relative mx-auto mt-[60px] w-full min-w-0 max-w-[1440px] px-5 md:px-10 xl:px-[100px]">
        <motion.h2
          className="mb-[30px] text-[32px] font-bold leading-[48px] text-black md:text-[40px]"
          variants={fadeUp}
          initial="hidden"
          whileInView="show"
          viewport={viewportOnce}
        ...
        <Stagger className="grid grid-cols-1 items-start gap-6 sm:grid-cols-2 xl:grid-cols-4">
